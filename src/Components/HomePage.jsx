    ...
    <div style={{position:"relative"}}  className='banner'> 
       ...
       <img  style={{width:"100%"}} src={backimg} />
        <div style={{position:"absolute",top:"30px"}}>
          <div style={{marginLeft:"70px", marginTop:"320px"}}> 
        ...
        <div style={{display:"flex",width:"24%",border:"2px solid white",position:"absolute",top:"40%",backgroundColor:"white",height:"65px",borderRadius:"15px",marginLeft:"60px", marginTop: "250px"}} className='signupbox'> 
